...
BOOST_AUTO_TEST_CASE(check_sph_kern)
{
    ...
    FLOATS_NEAR_TO(sph_cubic_kernel(1),0);
    FLOATS_NEAR_TO(sph_cubic_kernel(0),norm);
    FLOATS_NEAR_TO(sph_cubic_kernel(0.5),0.25*norm);
    FLOATS_NEAR_TO(sph_cubic_kernel(0.25),0.71875*norm);
    FLOATS_NEAR_TO(sph_cubic_kernel(0.75),0.03125*norm);
}
